...
* @since   2018-04-12 
*/
package com.example.kevinlee.chessandroid.src.board;
...
import com.example.kevinlee.chessandroid.src.piece.*;
import com.example.kevinlee.chessandroid.src.player.Player;
